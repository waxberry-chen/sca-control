...
PREF0 void  htz_Set_Channel(int Channel,int enable,int range,int AC_DC);
PREF0 void  htz_Set_Time_Base(uint32_t Time_Base, uint32_t NoOf_Samples);
PREF0 void  htz_Set_Trigger(int enable,int channel,int th,int type);
PREF0 void  htz_Set_Buffer(int16_t BufferA[],int16_t BufferB[],int16_t BufferC[],int16_t BufferD[],
                    int16_t ena,int16_t enb,int16_t enc,int16_t end,uint32_t NoOf_Samples);
PREF0 void  htz_Run_Block(uint32_t Time_Base, uint32_t NoOf_Samples,int NoOf_Channel);
PREF0 void  htz_get_data(uint32_t NoOf_Samples,int NoOf_Channel);
PREF0 void  htz_open_pico();
PREF0 int16_t   htz_mv_to_adc(int16_t mv , int16_t ch);
PREF0 int32_t   htz_adc_to_mv(int32_t raw, int32_t ch);
//**************************************//
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aFlashLed)   //闪烁LED
(
  int16_t  handle,
  int16_t  start
);
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aMemorySegments)   //内存分区
(
  int16_t           handle,
  uint32_t  nSegments,
  int32_t           *nMaxSamples
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aSetDigitalPort)  //数字通道
(
  int16_t                 handle,
...
PREF0 PREF1 PICO_STATUS PREF2 PREF3 (ps3000aSetBandwidthFilter)  //设带宽
(
  int16_t                      handle,
  PS3000A_CHANNEL            channel,
...
(
  ...
  uint32_t                delay,
  int16_t                        autoTrigger_ms   //0  一直等trigger
);
