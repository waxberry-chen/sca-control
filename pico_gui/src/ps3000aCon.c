...
//int16_t BufferA[128]={0};
//int16_t BufferB[128]={0};
//typedef enum
//{
//	ANALOGUE,
//	DIGITAL,
...
////******************* htz func *****************//
//void  htz_Set_Channel(int Channel,int enable,int range,int AC_DC)
//{
//    the_pico.channelSettings[Channel].range = range;
//    the_pico.channelSettings[Channel].enabled = enable;
//    the_pico.channelSettings[Channel].DCcoupled = AC_DC;

//    ps3000aSetChannel(the_pico.handle,
//                      Channel,
//                      the_pico.channelSettings[Channel].enabled,
//                      the_pico.channelSettings[Channel].DCcoupled,
//                      the_pico.channelSettings[Channel].range,
//                      0);
//}

//void  htz_Set_Time_Base(uint32_t Time_Base,uint32_t NoOf_Samples)
//{
//    ps3000aGetTimebase(the_pico.handle, Time_Base, NoOf_Samples, NULL, 1,NULL, 0);
//}

//void htz_Set_Trigger(int enable,int channel,int th,int type)
//{
//    ps3000aSetSimpleTrigger(the_pico.handle,enable,channel,th,type,0,0);
//}

//void htz_Set_Buffer(int16_t BufferA[],int16_t BufferB[],int16_t BufferC[],int16_t BufferD[],
//                    int16_t ena,int16_t enb,int16_t enc,int16_t end,uint32_t NoOf_Samples)
//{
//    if(ena) ps3000aSetDataBuffer(the_pico.handle,PS3000A_CHANNEL_A,BufferA,NoOf_Samples,0,PS3000A_RATIO_MODE_NONE);
//    if(enb) ps3000aSetDataBuffer(the_pico.handle,PS3000A_CHANNEL_B,BufferB,NoOf_Samples,0,PS3000A_RATIO_MODE_NONE);
//    if(enc) ps3000aSetDataBuffer(the_pico.handle,PS3000A_CHANNEL_C,BufferC,NoOf_Samples,0,PS3000A_RATIO_MODE_NONE);
//    if(end) ps3000aSetDataBuffer(the_pico.handle,PS3000A_CHANNEL_D,BufferD,NoOf_Samples,0,PS3000A_RATIO_MODE_NONE);


//}

//void htz_Run_Block(uint32_t Time_Base, uint32_t NoOf_Samples,int NoOf_Channel)
//{
//    ps3000aRunBlock(the_pico.handle,NoOf_Samples*1/4,NoOf_Samples*3/4,Time_Base,0,NULL,0,callBackBlock, NULL);
//    //this->hw->pData_In->write(0x0002,0x0001);

//}
//void htz_get_data(uint32_t NoOf_Samples,int NoOf_Channel)
//{
//    while(!g_ready) { Sleep(0); }
//    if(g_ready){
//        for(int i=0;i<NoOf_Channel;i++)
//        {
//            ps3000aGetValues(the_pico.handle, i*NoOf_Samples, (uint32_t*) &(NoOf_Samples), 1, PS3000A_RATIO_MODE_NONE, 0, NULL);
//        }
//        g_ready = FALSE;
//    }
//}
//int16_t  htz_mv_to_adc(int16_t mv, int16_t ch)
//{
//    return  (mv * the_pico.maxValue) / inputRanges[ch];
//}

//int32_t htz_adc_to_mv(int32_t raw, int32_t ch)
//{
//    return (raw * inputRanges[ch]) / the_pico.maxValue;
//}

//void  htz_open_pico()
//{

//    uint32_t noOfSamples = 1024;
//    uint32_t time_base = 2;
//    uint32_t nMaxSamples;
//    uint32_t i;
//    openDevice(&the_pico);
////    the_pico.channelSettings[PS3000A_CHANNEL_A].range = PS3000A_2V;
////    the_pico.channelSettings[PS3000A_CHANNEL_A].enabled = TRUE;
////    the_pico.channelSettings[PS3000A_CHANNEL_A].DCcoupled = PS3000A_AC;
////    ps3000aSetChannel(the_pico.handle,
////                      PS3000A_CHANNEL_A,
////                      the_pico.channelSettings[PS3000A_CHANNEL_A].enabled,
////                      the_pico.channelSettings[PS3000A_CHANNEL_A].DCcoupled,
////                      the_pico.channelSettings[PS3000A_CHANNEL_A].range,
////                      0);


////    the_pico.channelSettings[PS3000A_CHANNEL_B].range = PS3000A_5V;
////    the_pico.channelSettings[PS3000A_CHANNEL_B].enabled = TRUE;
////    the_pico.channelSettings[PS3000A_CHANNEL_B].DCcoupled = PS3000A_AC;
////    ps3000aSetChannel(the_pico.handle,
////                      PS3000A_CHANNEL_B,
////                      the_pico.channelSettings[PS3000A_CHANNEL_B].enabled,
////                      the_pico.channelSettings[PS3000A_CHANNEL_B].DCcoupled,
////                      the_pico.channelSettings[PS3000A_CHANNEL_B].range,
////                      0);

////    ps3000aGetTimebase(the_pico.handle, time_base, noOfSamples, NULL, 1,NULL, 0);

////    ps3000aSetSimpleTrigger(the_pico.handle,TRUE,PS3000A_CHANNEL_B,0,PS3000A_RISING,0,0);


////    //ps3000aMemorySegments(the_pico.handle,2,&nMaxSamples);
////    ps3000aSetDataBuffer(the_pico.handle,PS3000A_CHANNEL_A,BufferA,noOfSamples,0,PS3000A_RATIO_MODE_NONE);
////    ps3000aSetDataBuffer(the_pico.handle,PS3000A_CHANNEL_B,BufferB,noOfSamples,0,PS3000A_RATIO_MODE_NONE);


////    ps3000aRunBlock(the_pico.handle,512,512,time_base,0,NULL,0,callBackBlock, NULL);

//////noOfSamples = 256;
////    while(!g_ready) { Sleep(0); }
////    if(g_ready){
////        ps3000aGetValues(the_pico.handle, 0  , (uint32_t*) &(noOfSamples), 1, PS3000A_RATIO_MODE_NONE, 0, NULL);
////        ps3000aGetValues(the_pico.handle, 512, (uint32_t*) &(noOfSamples), 1, PS3000A_RATIO_MODE_NONE, 0, NULL);
////    }
//}
